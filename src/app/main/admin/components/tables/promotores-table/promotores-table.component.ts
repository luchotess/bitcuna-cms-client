...
@Component({
    selector: 'promotores-table',
    templateUrl: './promotores-table.component.html',
    styleUrls: ['./promotores-table.component.scss']
})
export class PromotoresTableComponent implements OnInit {
